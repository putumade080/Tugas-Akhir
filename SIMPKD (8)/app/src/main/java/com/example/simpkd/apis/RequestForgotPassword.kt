...
fun requestForgotPassword(contextView: View, requestParams: HashMap<String, String>,
    ...
    VolleyMultipartRequest(contextView.context, Request.Method.POST,
        "${Constants.BASE_URL}/pegawai/request-forgot-password/", HashMap(), requestParams,
        fileRequestParams, {
